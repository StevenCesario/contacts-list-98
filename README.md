...
It gave a very healthy and fun journey moving from my brain dumped fully working but all over the place spaghetti code with a God function to a more pragmatic orthogonal system that has become my blueprint for the second assignment with API integration (I used the Spotify and called it Vibe Salad, will be Public soon), my [Lock In Intentional Timer](https://github.com/StevenCesario/lock-in-intention-timer) and all future Full Stack project builds!
